    ...
    public function addMenu($param = null) {
        ...
        if (is_array($this->menu)) {
            ...
            if ($this->menu[0] <> '' && $this->menu[1] <> '') {
                /* add the translation */
                $this->menu[0] = __($this->menu[0], _CL_PLUGIN_NAME_);
                $this->menu[1] = __($this->menu[1], _CL_PLUGIN_NAME_);
    ...
    public function addMeta($param = null) {
        ...
        if (is_array($this->meta)) {
            ...
            if ($this->meta[0] <> '' && $this->meta[1] <> '') {
                /* add the translation */
                $this->meta[1] = __($this->meta[1], _CL_PLUGIN_NAME_);
...
//print_r($this->meta);
                ...
                //add_meta_box('post'._CL_PLUGIN_NAME_, __(ucfirst(_CL_PLUGIN_NAME_),_CL_PLUGIN_NAME_), array($this, 'showMenu'), 'post', 'side', 'high');
            }
        }
    }
